...
| `onComplete`      | `"NoOp"`\|`"OptIn"`\|<br/>`"CloseOut"`\|`"Update"`\|`"Delete"` | OPTIONAL. Describes the action that must be done after the call execution. By default is set to `"NoOp"`. |
...
| `accounts`        | `Array<string>`                    | OPTIONAL. The accounts arguments. |
| `assets`          | `Array<number>`                    | OPTIONAL. The assets arguments. |
| `applications`    | `Array<number>`                    | OPTIONAL. The applications arguments. |
