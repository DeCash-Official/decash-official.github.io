...
Close the balance of a DeCash asset of a [DelegatedWallet](/docs/concepts/delegated-wallets), sending the remaining funds to another (regular or delegated) wallet.
