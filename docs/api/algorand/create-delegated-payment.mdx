...
| `receiver`        | `string` | The address of the account that is receiving the funds. Note that, if this account is not a [Delegated Wallet](/docs/concepts/delegated-wallets), then it must be opted into the token that is being sent. | 
